...
class InfAccScreen extends StatefulWidget {
  const InfAccScreen({super.key});

  @override
  State<InfAccScreen> createState() => _InfAccScreenState();
}

class _InfAccScreenState extends State<InfAccScreen> {
